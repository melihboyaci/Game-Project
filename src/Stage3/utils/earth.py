...
class Earth(Planet):
    def __init__(self, image_path, size, position, scale):
        ...
        self.explosion_sprite = AnimatedSprite(self.explosion_frames, position, frame_delay=200)
        self.explosion_time = 0
        self.explosion_duration = 1600
    ...
    def update(self):
        if self.health <= 0 and self.exploding==False:
            self.exploding = True
